...
.ant-select-single.ant-select-lg:not(.ant-select-customize-input) .ant-select-selector .ant-select-selection-wrap::after {
  line-height: 38px;
}
...
.ant-select-single.ant-select-sm:not(.ant-select-customize-input) .ant-select-selector .ant-select-selection-wrap::after {
  line-height: 22px;
}
...
.ant-select-multiple .ant-select-selector .ant-select-prefix {
  margin-inline-start: calc(11px - max(calc(4px - 1px), 0px));
}
.ant-select-multiple .ant-select-selector .ant-select-selection-wrap {
...
.ant-select-multiple .ant-select-selector .ant-select-selection-overflow-item-suffix {
  min-height: 24px;
...
.ant-select-multiple .ant-select-prefix + .ant-select-selection-wrap .ant-select-selection-search {
  margin-inline-start: 0;
}
.ant-select-multiple .ant-select-selection-overflow-item + .ant-select-selection-overflow-item .ant-select-selection-placeholder,
.ant-select-multiple .ant-select-prefix + .ant-select-selection-wrap .ant-select-selection-placeholder {
  margin-inline-start: 0;
}
