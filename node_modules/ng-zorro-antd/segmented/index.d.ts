...
declare class NzSegmentedItemComponent implements OnInit {
    ...
    readonly nzValue: i0.InputSignal<string | number>;
    readonly nzIcon: i0.InputSignal<string | undefined>;
    readonly nzDisabled: i0.InputSignalWithTransform<boolean, unknown>;
    readonly hasLabel: i0.Signal<boolean>;
    protected readonly isChecked: i0.WritableSignal<boolean>;
    readonly parentDisabled: i0.Signal<boolean>;
    ngOnInit(): void;
    handleClick(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NzSegmentedItemComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NzSegmentedItemComponent, "label[nz-segmented-item],label[nzSegmentedItem]", ["nzSegmentedItem"], { "nzValue": { "alias": "nzValue"; "required": true; "isSignal": true; }; "nzIcon": { "alias": "nzIcon"; "required": false; "isSignal": true; }; "nzDisabled": { "alias": "nzDisabled"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, never>;
}
...
declare class NzSegmentedComponent implements OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzSegmentedComponent, "nz-segmented", ["nzSegmented"], { "nzBlock": { "alias": "nzBlock"; "required": false; }; "nzDisabled": { "alias": "nzDisabled"; "required": false; }; "nzOptions": { "alias": "nzOptions"; "required": false; }; "nzVertical": { "alias": "nzVertical"; "required": false; }; "nzSize": { "alias": "nzSize"; "required": false; }; }, { "nzValueChange": "nzValueChange"; }, ["contentItemCmps"], ["*"], true, never>;
